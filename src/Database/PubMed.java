...
public class PubMed {
    ...
    public static void main(String[] args)  throws FailingHttpStatusCodeException, MalformedURLException, IOException {
        PubMed yale = new PubMed("https://www.ncbi.nlm.nih.gov/pubmed/?term=skin+cancer");
    ...
    public String intialRun() throws FailingHttpStatusCodeException, MalformedURLException, IOException {
        ...
        for(int i=0; i < 10; i++){
            ...
            if(!this.resources[i].contains("Similar articles")){
                this.resources[i] = this.resources[i].substring(this.resources[i].indexOf("<a href=\"") +9, this.resources[i].indexOf("ref=\"ordinalpos")-2);
